const CACHE_NAME='titan-v16-shell-v1';
const ASSETS=['./','./index.html','./student_secure_live_classroom_v15_customization_studio.html','./admin_secure_live_classroom_v15_customization_studio.html','./parent_portal_v15_customization_studio.html','./manifest.webmanifest'];
